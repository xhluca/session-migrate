...
const description = "Move coding agent sessions among Claude Code, Codex, Pi, OpenCode, Copilot, Antigravity, Mistral Vibe, and Cursor.";
const image = `${origin}/og-eight-harnesses.png`;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1731,
      height: 909,
      alt: "Migrate sessions among Claude Code, Codex, Pi, OpenCode, Copilot, Antigravity, Mistral Vibe, and Cursor",
    }],
  },
