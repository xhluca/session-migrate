...
- [x] Cross-check every CLI command and option against implementation/help.
- [x] Add an authoritative CLI/output/manifest reference.
- [x] Add troubleshooting, recovery, and contributor/release guides.
